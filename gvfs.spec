...
Source0  : https://download.gnome.org/sources/gvfs/1.48/gvfs-1.48.1.tar.xz
...
%prep
%setup -q -n gvfs-1.48.1
cd %{_builddir}/gvfs-1.48.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619805886
...
cp %{_builddir}/gvfs-1.48.1/COPYING %{buildroot}/usr/share/package-licenses/gvfs/ec8f58b945698929990e5ab50ec5350ab184cfdd
cp %{_builddir}/gvfs-1.48.1/daemon/trashlib/COPYING %{buildroot}/usr/share/package-licenses/gvfs/8624bcdae55baeef00cd11d5dfcfa60f68710a02
