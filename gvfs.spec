...
Source0  : https://download.gnome.org/sources/gvfs/1.54/gvfs-1.54.0.tar.xz
...
%prep
%setup -q -n gvfs-1.54.0
cd %{_builddir}/gvfs-1.54.0
pushd ..
cp -a gvfs-1.54.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710889027
