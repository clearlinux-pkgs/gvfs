...
Version  : 1.32.0
Release  : 7
URL      : https://download.gnome.org/sources/gvfs/1.32/gvfs-1.32.0.tar.xz
Source0  : https://download.gnome.org/sources/gvfs/1.32/gvfs-1.32.0.tar.xz
...
%prep
%setup -q -n gvfs-1.32.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490637660
