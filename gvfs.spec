...
Version  : 1.54.1
Release  : 84
URL      : https://download.gnome.org/sources/gvfs/1.54/gvfs-1.54.1.tar.xz
Source0  : https://download.gnome.org/sources/gvfs/1.54/gvfs-1.54.1.tar.xz
...
%prep
%setup -q -n gvfs-1.54.1
cd %{_builddir}/gvfs-1.54.1
pushd ..
cp -a gvfs-1.54.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716832057
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Ddnssd=false \
-Dafc=false \
-Dbluray=false \
-Dcdda=false \
-Dnfs=false \
