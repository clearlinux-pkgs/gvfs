...
Version  : 1.34.2
Release  : 26
URL      : https://download.gnome.org/sources/gvfs/1.34/gvfs-1.34.2.tar.xz
Source0  : https://download.gnome.org/sources/gvfs/1.34/gvfs-1.34.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1517924419
export AR=gcc-ar
