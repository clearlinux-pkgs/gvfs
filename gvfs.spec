...
Version  : 1.52.1
Release  : 81
URL      : https://download.gnome.org/sources/gvfs/1.52/gvfs-1.52.1.tar.xz
Source0  : https://download.gnome.org/sources/gvfs/1.52/gvfs-1.52.1.tar.xz
...
%prep
%setup -q -n gvfs-1.52.1
cd %{_builddir}/gvfs-1.52.1
pushd ..
cp -a gvfs-1.52.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697837687
