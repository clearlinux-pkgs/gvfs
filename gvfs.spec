...
Source0  : https://download.gnome.org/sources/gvfs/1.52/gvfs-1.52.2.tar.xz
...
%prep
%setup -q -n gvfs-1.52.2
cd %{_builddir}/gvfs-1.52.2
pushd ..
cp -a gvfs-1.52.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704485642
